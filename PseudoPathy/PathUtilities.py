...
class SoftwareDirs:
	...
	def userCacheDir(self):
		return appdirs.user_cache_dir(self.SOFTWARE_NAME, self.AUTHOR_NAME, self.VERSION_NAME, self.ROAMING)
	@cached_property
	def userLogDir(self):
		return appdirs.user_log_dir(self.SOFTWARE_NAME, self.AUTHOR_NAME, self.VERSION_NAME, self.ROAMING)
