...
__all__ = (
    "align2", "align", "alignName", "alignSignature", "alignPattern"
)
...
def alignPattern(string : str, *strings : str):
    return align(string, *strings, gapSymbol="*", missMatchSymbol="?", compressed=True)